 ...
 * `verify` script that invokes the CLI. Returns the names of scripts actually added.
 */
export function addVerifyScripts(packageJsonPath: string, scripts: Record<string, string>): string[] {
